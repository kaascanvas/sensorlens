    ...
    <div id="hud" class="minimized">
        ...
        <div class="hud-body">
            ...
            <div class="hud-tools" style="grid-template-columns: repeat(4, 1fr);">
                ...
                <button id="btn-laser-game" class="tool-btn" style="grid-column: span 4;">LASER GAME</button>
...
<body>
    ...
    <section id="lensdj" class="section-container">
        ...
        <h2>LensDJ Pro <span style="font-size: 1rem; vertical-align: middle; background: var(--accent-sec); color: #fff; padding: 4px 10px; border-radius: 4px; margin-left: 10px; font-weight: 800; text-shadow: none;">$59.99 LIFETIME</span></h2>
